...
class Robot:
    ...
    def clean_clockwise(self):
        GPIO.output(self.M_brosses_ccw,LOW)
        GPIO.output(self.M_brosses_cw,HIGH)

    def clean_counterclockwise(self):
        GPIO.output(self.M_brosses_cw,LOW)
        GPIO.output(self.M_brosses_ccw,HIGH)
...
def giro(self):
    ...
    def cas0(self,n):
        ...
        while statistics["face"][1] < 430:  # tant qu'il y a le panneau devant (à une distance de 430mm)
            statistics = self.data_analysis()
            if statistics["d_droit"] > 250 + 500*n:
                self.droite_slow()
            elif statistics["d_droit"] < 250 + 500*n:
                self.gauche_slow()
        n += 1
        return 2
    ...
    def cas1(self,n):
        ...
        while statistics["face"][1] < 430:  # tant qu'il y a le panneau devant (à une distance de 430mm)
            statistics = self.data_analysis()
            if statistics["d_gauche"] > 250 + 500*n:
                self.gauche_slow()  # fonction à déterminer
            elif statistics["d_gauche"] < 250 + 500*n:
                self.droite_slow()
        n += 1
        return 3
    ...
    def cas4(self):
        ...
        while statistics["face"][1] < 430:   # tant qu'il y a le panneau devant (à une distance de 430mm)
            statistics = self.data_analysis()
            if statistics["d_droit"] > 250:
                self.droite_slow()    # fonction à déterminer
            elif statistics["d_droit"] < 250:
                self.gauche_slow()
    ...
    def cas5(self):
        ...
        while statistics["face"][1] < 430:  # tant qu'il y a le panneau devant (à une distance de 430mm)
            statistics = self.data_analysis()
            if statistics["d_gauche"] > 250:
                self.gauche_slow()  # fonction à déterminer
            elif statistics["d_gauche"] < 250:
                self.droite_slow()
